...
class HandPoseCalibrationModel: ObservableObject {
    ...
    private func changeCalibrationPose(toPoseAtIndex index: Int) {
        calibrationState = .CalibratingChangePose(pose: HandTrackerCalibrationDefaults.CalibrationOrder[index])
    ...
    private func calibratePose(atIndex index: Int) {
        calibrationState = .CalibratingPose(pose: HandTrackerCalibrationDefaults.CalibrationOrder[index])
